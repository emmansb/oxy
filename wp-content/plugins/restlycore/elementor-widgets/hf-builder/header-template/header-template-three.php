...
class restly_header_template_three extends Widget_Base {

    public function get_name() {

        return 'restly_header_template_three';
    }

    public function get_title() {
        return esc_html__( 'Restly Header Three', 'restlycore' );
    }
...
Plugin::instance()->widgets_manager->register( new restly_header_template_three );