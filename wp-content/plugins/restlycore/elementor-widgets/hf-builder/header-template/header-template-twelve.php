...
class restly_header_template_twelve extends Widget_Base {

    public function get_name() {

        return 'restly_header_template_twelve';
    }

    public function get_title() {
        return esc_html__( 'Restly Header Twelve', 'restlycore' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .header-twelve .main-header.sticky-bar .navbar' => 'background-color: {{VALUE}}',
                ],
                'condition' => [
                    'enable_sticky' => 'yes',
                ],
...
$this->end_controls_section();
            ...
            $this->start_controls_tabs(
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .header-twelve .header-top' => 'height: {{SIZE}}{{UNIT}};',
                        ],
                    ]
                );
                $this->add_responsive_control(
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .header-twelve .header-top .top-header-right ul li span' => 'margin-right: {{SIZE}}{{UNIT}};',
                        ],
                    ]
                );
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'type'      => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .header-twelve .header-top .top-header-right ul li span' => 'color: {{VALUE}}',
                        ],
                    ]
                );
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'type'      => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .header-twelve .header-top .top-header-right ul li' => 'color: {{VALUE}}',
                        ],
                    ]
                );
                $this->add_group_control(
                    ...
                    [
                        ...
                        'selector' => '{{WRAPPER}} .header-twelve .header-top .top-header-right ul li,{{WRAPPER}} .header-twelve .header-top .top-header-right ul li i',
                    ]
                );
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                        'selectors'  => [
                            '{{WRAPPER}} .header-twelve .header-top .top-header-right ul li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ]
                );
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                        'selectors'  => [
                            '{{WRAPPER}} .header-twelve .header-top .top-header-right ul li' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ]
                );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .header-twelve .logo-area .site-branding .site-title a',
            ]
        );
        $this->add_responsive_control(
            'logo_color',
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header-twelve .logo-area .site-branding .site-title a' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types' => [ 'classic', 'gradient', 'video' ],
                'selector' => '{{WRAPPER}} .header-twelve .main-header .navbar',
                'separator' => 'before',
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .header-twelve .main-header .navbar' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .header-twelve .main-header .navbar' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .header-twelve .main-header .navbar' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
    ...
    protected function render() {
        ...
        <header id="masthead" class="site-header header-twelve tp-header restly-header-template-twelve">
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 top-header-left">
                                <?php if ( !empty( $settings['Promotion_text'] ) ): ?>
                                    <div class="promation_text">
                                        <?php \Elementor\Icons_Manager::render_icon( $settings['Promotion_icon']); ?>
                            ...
                            <?php if ( $settings['items'] ) : ?>
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-8  top-header-right">
                                    <ul>
                                        ...
                                        <li><span><?php \Elementor\Icons_Manager::render_icon( $item['top_list_icon'], [ 'aria-hidden' => 'true' ] ); ?></span><?php echo wp_kses( $item['left_content'], 'restly_allowed_html' ); ?></li>
                                        <?php endforeach;?>
                                    </ul>
                                </div>
                            <?php endif; ?>
        ...
        <script>
            (function ($) {
                "use strict";
                jQuery(".site").addClass("header-template-twelve-activate");
...
Plugin::instance()->widgets_manager->register( new restly_header_template_twelve );