...
class restly_header_template_ten extends Widget_Base {

    public function get_name() {

        return 'restly_header_template_ten';
    }

    public function get_title() {
        return esc_html__( 'Restly Header Ten', 'restlycore' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Welcome to Restly a modern saas landing template. Have any projects <a href="#">Contact Us</a>', 'restlycore' ),
                'condition' => [
        ...
        $this->add_control(
            'login_notes',
            [
                'label' => esc_html__( 'Login Options', 'restlycore' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'login_enable',
            [
                'label' => esc_html__( 'Enable Login Button', 'restlycore' ),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'restlycore' ),
                'label_off' => esc_html__( 'Hide', 'restlycore' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'login_text',
            [
                'label' => esc_html__( 'Login Text', 'restlycore' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( 'Login', 'restlycore' ),
                'condition' => [
                    'login_enable' => 'yes',
                ],
            ]
        ...
        $this->add_control(
            'login_icon',
            [
                'label' => esc_html__( 'Login Icon', 'restlycore' ),
        ...
        $this->add_control(
            'button_notes',
            [
                'label' => esc_html__( 'Button Options', 'restlycore' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'top_typography',
                'selector' => '{{WRAPPER}} .header-ten .header-top',
            ]
        );
        $this->add_responsive_control(
            'top_color',
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header-ten .header-top' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header-ten .header-top a' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            'top_hcolor',
            [
                'label' => esc_html__( 'Hover Link Color', 'restlycore' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header-ten .header-top a:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .header-ten .header-top' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .header-ten .header-top' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .header-ten .header-top' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors'  => [
                    '{{WRAPPER}} .logo-area a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors'  => [
                    '{{WRAPPER}} .logo-area a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'login_typo',
                'selector' => '{{WRAPPER}} .header-ten a.login',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header-ten a.login' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header-ten a.login:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .header-ten a.login' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .header-ten a.login' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        <header id="masthead" class="site-header header-ten tp-header restly-header-template-ten">
            <?php if ( $settings['enable_top_header'] == 'yes' ): ?>
                <div class="header-top">
                    <div class="container">
                        <?php echo wp_kses_post( $settings['top_content'] ); ?>
                    </div>
                </div>
            <?php endif; ?>
                ...
                <div class="header-upper">
                    <div class="container">
                        <nav class="navbar navbar-expand-lg navbar-light main-navigation" id="site-navigation">
                            ...
                            <?php if( $settings['login_enable'] == 'yes' ) : 
                                if ( ! empty( $settings['login_url']['url'] ) ) {
                                    $this->add_link_attributes( 'login_url', $settings['login_url'] );
                                }
                            ?>
                                <a <?php echo $this->get_render_attribute_string( 'login_url' ); ?> class="login"><?php \Elementor\Icons_Manager::render_icon( $settings['login_icon'], [ 'aria-hidden' => 'true' ] ); ?><?php echo esc_html( $settings['login_text'] ); ?></a>
                            <?php endif; ?>
...
Plugin::instance()->widgets_manager->register( new restly_header_template_ten );