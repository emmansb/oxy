...
class restly_header_template_nine extends Widget_Base {

    public function get_name() {

        return 'restly_header_template_nine';
    }

    public function get_title() {
        return esc_html__( 'Restly Header Nine', 'restlycore' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__( 'WALLET CONNECT', 'restlycore' ),
                'label_block' => true,
                'condition'   => [
                    'enable_btn' => 'yes',
                ],
            ...
            $this->start_controls_tabs(
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                        'selectors'  => [
                            '{{WRAPPER}} .theme-btns.gradient-btn-one' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ]
                );
                $this->add_group_control(
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                        'selectors'  => [
                            '{{WRAPPER}} .theme-btns.gradient-btn-one:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ]
                );
                $this->add_group_control(
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'search_typo',
                'selector' => '{{WRAPPER}} .site-header .button.search-open',
            ]
        );
        $this->add_responsive_control(
            'search_width',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .site-header .button.search-open' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .site-header .button.search-open' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .site-header .button.search-open' => 'background-color: {{VALUE}}',
                            ],
                        ]
                    );
                    $this->add_group_control(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                            'selectors' => [
                                '{{WRAPPER}} .button.search-open' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    $this->add_group_control(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .site-header .button.search-open:hover' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .site-header .button.search-open:hover' => 'background-color: {{VALUE}}',
                            ],
                        ]
                    );
                    $this->add_group_control(
                        ...
                        [
                            'name' => 'search_hborder',
                            'selector' => '{{WRAPPER}} .button.search-open:hover',
                        ]
                    );
                    $this->add_responsive_control(
                        'search_hradius',
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                            'selectors' => [
                                '{{WRAPPER}} .button.search-open:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    $this->add_group_control(
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'cart_typo',
                'selector' => '{{WRAPPER}} .restly-hmini a span.fas',
            ]
        );
        $this->add_responsive_control(
            'cart_width',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .restly-hmini a span.fas' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .restly-hmini a span.fas' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .header-nine ul.restly-hmini' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .header-nine ul.restly-hmini' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .restly-hmini a span.fas' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .restly-hmini a span.fas' => 'background-color: {{VALUE}}',
                            ],
                        ]
                    );
                    $this->add_group_control(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                            'selectors' => [
                                '{{WRAPPER}} .restly-hmini a span.fas' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    $this->add_group_control(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .restly-hmini a span.fas:hover' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .restly-hmini a span.fas:hover' => 'background-color: {{VALUE}}',
                            ],
                        ]
                    );
                    $this->add_group_control(
                        ...
                        [
                            'name' => 'cart_hborder',
                            'selector' => '{{WRAPPER}} .restly-hmini a span.fas:hover',
                        ]
                    );
                    $this->add_responsive_control(
                        'cart_hradius',
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                            'selectors' => [
                                '{{WRAPPER}} .restly-hmini a span.fas:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    $this->add_group_control(
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'background',
                'types' => [ 'classic', 'gradient', 'video' ],
                'selector' => '{{WRAPPER}} ul.restly-hmini span.count',
            ]
        );
        $this->end_controls_section();
    }
    ...
    protected function render() {
        ...
        <header id="masthead" class="site-header header-nine tp-header restly-header-template-nine">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light main-navigation" id="site-navigation">
                        ...
                        ?>
                            <div class="button wallet">
                                <a <?php echo $this->get_render_attribute_string( 'button_url' ); ?> class="theme-btns gradient-btn-one"><?php echo esc_html( $settings['button_text'] ); ?></a>
                            </div>
                        <?php endif;?>
        ...
        <script>
            (function ($) {
                "use strict";
                jQuery(".site").addClass("header-template-nine-activate");
            })(jQuery);
        </script>
        <?php
echo ob_get_clean();
...
Plugin::instance()->widgets_manager->register( new restly_header_template_nine );