...
class restly_header_template_one extends Widget_Base {

    public function get_name() {

        return 'restly_header_template_one';
    }

    public function get_title() {
        return esc_html__( 'Restly Header One', 'restlycore' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .logobg:after' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors'  => [
                    '{{WRAPPER}} .logo-area.logobg' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors'  => [
                    '{{WRAPPER}} .logo-area.logobg' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
...
Plugin::instance()->widgets_manager->register( new restly_header_template_one );