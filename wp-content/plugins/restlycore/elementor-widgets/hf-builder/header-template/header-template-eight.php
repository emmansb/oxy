...
class restly_header_template_eight extends Widget_Base {

    public function get_name() {

        return 'restly_header_template_eight';
    }

    public function get_title() {
        return esc_html__( 'Restly Header Eight', 'restlycore' );
    }
    ...
    protected function register_controls() {
            ...
            $this->start_controls_tabs(
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'type'        => \Elementor\Controls_Manager::TEXT,
                        'default'     => esc_html__( 'Welcome To Restly', 'restlycore' ),
                        'show_label'  => true,
                        'label_block' => true,
                        'condition'   => [
                            'enable_top_header' => 'yes',
        ...
        $this->add_responsive_control(
            'logo_bg',
            [
                'label'     => esc_html__( 'Logo Background', 'restlycore' ),
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header-eight .logo-area a' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_section();
            ...
            $this->start_controls_tabs(
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'type'      => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .header-top .top-header-left.top8 ul li span' => 'color: {{VALUE}}',
                        ],
                    ]
                );
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'type'      => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .header-top .top-header-left.top8 ul li'   => 'color: {{VALUE}}',
                            '{{WRAPPER}} .header-top .top-header-left.top8 ul li a' => 'color: {{VALUE}}',
                        ],
                    ]
                );
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'type'      => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .header-top .top-header-left.top8 ul li a:hover' => 'color: {{VALUE}}',
                        ],
                    ]
                );
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                        'selectors'  => [
                            '{{WRAPPER}} .header-top .top-header-left.top8 ul li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ]
                );
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                        'selectors'  => [
                            '{{WRAPPER}} .header-top .top-header-left.top8 ul li' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ]
                );
                ...
                $this->add_group_control(
                    ...
                    [
                        'name'     => 'top_laft_typo',
                        'selector' => '{{WRAPPER}} .header-top .top-header-left.top8 ul li, {{WRAPPER}} .header-top .top-header-left.top8 ul li a, {{WRAPPER}} .header-top .top-header-left.top8 ul li span',
                    ]
                );
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'type'      => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .header-top .top8 ul li span i' => 'color: {{VALUE}}',
                        ],
                    ]
                );
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'type'      => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .header-top .top8 .eight-email-list ul li' => 'color: {{VALUE}}',
                        ],
                    ]
                );
                $this->add_group_control(
                    ...
                    [
                        ...
                        'selector' => '{{WRAPPER}} .header-top .top8 .eight-email-list ul li',
                    ]
                );
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                        'selectors'  => [
                            '{{WRAPPER}} .header-top .top8 .eight-email-list ul li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ]
                );
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                        'selectors'  => [
                            '{{WRAPPER}} .header-top .top8 .eight-email-list ul li' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ]
                );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .header-eight .logo-area a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors'  => [
                    '{{WRAPPER}} .header-eight .logo-area' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors'  => [
                    '{{WRAPPER}} .header-eight .logo-area a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
                    ...
                    <div class="top-header-right top8">
                        ...
                        <?php if ( !empty( $settings['open_text'] ) ): ?>
                            <div class="eight-email-list">
                                <ul>
                                    <li><span><?php \Elementor\Icons_Manager::render_icon( $settings['time_icon'], ['aria-hidden' => 'true'] );?></span><?php echo esc_html( $settings['open_text'] ); ?></li>
                                </ul>
                            </div>
                        <?php endif;?>
...
Plugin::instance()->widgets_manager->register( new restly_header_template_eight );