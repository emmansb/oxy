...
class restly_header_template_thirteen extends Widget_Base {

    public function get_name() {

        return 'restly_header_template_thirteen';
    }

    public function get_title() {
        return esc_html__( 'Restly Header Thirteen', 'restlycore' );
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'restly@mail.com', 'restlycore' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => [
                    [
                        'top_left_title' => esc_html__( 'restly@mail.com', 'restlycore' ),
                    ],
                    [
                        'top_left_title' => esc_html__( 'Mon-Sat: 8:00-18:00, Sunday-Closed', 'restlycore' ),
                    ],
                ],
                'condition' => [
                    'enable_top_header' => 'yes',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .header-thirteen .main-header.sticky-bar' => 'background-color: {{VALUE}}',
                ],
                'condition' => [
                    'enable_sticky' => 'yes',
                ],
        ...
        $this->add_control(
            'cta_button_heading',
            [
                'label' => esc_html__( 'Call To Action', 'restlycore' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            'enable_cta_btn',
            [
                'label'        => esc_html__( 'Enable Call To Action', 'restlycore' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Show', 'restlycore' ),
                'label_off'    => esc_html__( 'Hide', 'restlycore' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'cta_button_text',
            [
                'label'       => esc_html__( 'CTA Button Text', 'restlycore' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'default'     => esc_html__( 'Meet With Us', 'restlycore' ),
                'label_block' => true,
                'condition'   => [
        ...
        $this->add_control(
            'cta_button_url',
            [
                'label'       => esc_html__( 'CTA Button Link', 'restlycore' ),
                'type'        => \Elementor\Controls_Manager::URL,
                'placeholder' => esc_html__( 'https://your-link.com', 'restlycore' ),
                'options'     => ['url', 'is_external', 'nofollow'],
                'default'     => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .header-thirteen .header-top ul li:not(:last-child)' => 'margin-right: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            ...
            $this->start_controls_tabs(
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .header-thirteen .top-header-left ul li span' => 'margin-right: {{SIZE}}{{UNIT}};',
                        ],
                    ]
                );
                $this->add_group_control(
                    ...
                    [
                        'name'     => 'top_laft_typo',
                        'selector' => '{{WRAPPER}} .header-thirteen .top-header-left ul li,{{WRAPPER}} .header-thirteen .top-header-left ul li span,{{WRAPPER}} .header-thirteen .top-header-left ul li a',
                    ]
                );
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'type'      => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .header-thirteen .top-header-left ul li' => 'color: {{VALUE}}',
                            '{{WRAPPER}} .header-thirteen .top-header-left ul li a' => 'color: {{VALUE}}',
                        ],
                    ]
                );
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'type'      => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .header-thirteen .top-header-left ul li span' => 'color: {{VALUE}}',
                        ],
                    ]
                );
                $this->add_responsive_control(
                    'top_left_contnt_color_hover',
                    [
                        'label'     => esc_html__( 'Hover Color', 'restlycore' ),
                        'type'      => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .header-thirteen .top-header-left ul li a:hover' => 'color: {{VALUE}}',
                        ],
                    ]
                );
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                        'selectors'  => [
                            '{{WRAPPER}} .header-thirteen .header-top ul li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ]
                );
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                        'selectors'  => [
                            '{{WRAPPER}} .header-thirteen .header-top ul li' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ]
                );
                $this->end_controls_tab();
                ...
                $this->add_control(
                    'header_top_social_normal_style',
                    [
                        'label' => esc_html__( 'Normal Style', 'restlycore' ),
                        'type' => \Elementor\Controls_Manager::HEADING,
                        'separator' => 'before',
                    ]
                );
                $this->add_group_control(
                    ...
                    [
                        ...
                        'selector' => '{{WRAPPER}} .header-thirteen .top-header-right ul li a span',
                    ]
                );
                $this->add_responsive_control(
                    'icon_width',
                    [
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .header-thirteen .top-header-right ul li a span' => 'width: {{SIZE}}{{UNIT}};',
                        ],
                    ]
                );
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .header-thirteen .top-header-right ul li a span' => 'height: {{SIZE}}{{UNIT}};',
                        ],
                    ]
                );
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'type' => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .header-thirteen .top-header-right ul li a span' => 'color: {{VALUE}}',
                        ],
                    ]
                );
                $this->add_group_control(
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'size_units' => [ 'px', '%', 'em' ],
                        'selectors' => [
                            '{{WRAPPER}} .header-thirteen .top-header-right ul li a span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ]
                );
                $this->add_group_control(
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'size_units' => [ 'px', '%', 'em' ],
                        'selectors' => [
                            '{{WRAPPER}} .header-thirteen .top-header-right ul li a span' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ]
                );
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'size_units' => [ 'px', '%', 'em' ],
                        'selectors' => [
                            '{{WRAPPER}} .header-thirteen .top-header-right ul li a span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ]
                );
                $this->add_control(
                    'header_social_hover_style',
                    [
                        'label' => esc_html__( 'Social Hover Style', 'restlycore' ),
                        'type' => \Elementor\Controls_Manager::HEADING,
                        'separator' => 'before',
                    ]
                );
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'type' => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .header-thirteen .top-header-right ul li a span:hover' => 'color: {{VALUE}}',
                        ],
                    ]
                );
                $this->add_group_control(
                    ...
                    [
                        ...
                        'types' => [ 'classic', 'gradient' ],
                        'selector' => '{{WRAPPER}} .header-thirteen .top-header-right ul li a span:hover',
                    ]
                );
                $this->add_group_control(
                    \Elementor\Group_Control_Border::get_type(),
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'size_units' => [ 'px', '%', 'em' ],
                        'selectors' => [
                            '{{WRAPPER}} .header-thirteen .top-header-right ul li a span:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ]
                );
                $this->add_group_control(
                ...
                $this->add_control(
                    'header_social_lavel_style',
                    [
                        'label' => esc_html__( 'Social Lavel Style', 'restlycore' ),
                        'type' => \Elementor\Controls_Manager::HEADING,
                        'separator' => 'before',
                    ]
                );
                $this->add_group_control(
                    \Elementor\Group_Control_Typography::get_type(),
                    [
                        'name'     => 'social_lavel_typo',
                        'selector' => '{{WRAPPER}} .header-thirteen .top-header-right ul li a',
                    ]
                );
                $this->add_responsive_control(
                    'social_lavel_color',
                    [
                        ...
                        'type'      => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .header-thirteen .top-header-right ul li a' => 'color: {{VALUE}}',
                        ],
                    ]
                );
                $this->add_responsive_control(
                    'social_lavel_color:hover',
                    [
                        'label'     => esc_html__( 'Label Hover Color', 'restlycore' ),
                        'type'      => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .header-thirteen .top-header-right ul li a' => 'color: {{VALUE}}',
                        ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .header-thirteen .logo-area .site-branding .site-title a',
            ]
        );
        $this->add_responsive_control(
            'logo_color',
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header-thirteen .logo-area .site-branding .site-title a' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_control(
            'menu_box_style',
            [
                'label' => esc_html__( 'menu Box Style', 'restlycore' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'types' => [ 'classic', 'gradient', 'video' ],
                'selector' => '{{WRAPPER}} .header-thirteen .main-header',
                'separator' => 'before',
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .header-thirteen .main-header' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .header-thirteen .main-header' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            'main_menu_style',
            [
                'label' => esc_html__( 'Main Menu Style', 'restlycore' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->end_controls_section();
        $this->start_controls_section(
            'button_css_options_v2',
            [
                'label' => esc_html__( 'Button Two Style', 'restlycore' ),
                'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .header-thirteen .theme-cta-btns i' => 'margin-right: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                'name'     => 'button_typo_v2',
                'selector' => '{{WRAPPER}} .button .theme-cta-btns',
            ]
        );
        $this->add_responsive_control(
            'button_box_margin_v2',
            [
                'label'      => esc_html__( 'Margin', 'restlycore' ),
                'type'       => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors'  => [
                    '{{WRAPPER}} .button .theme-cta-btns' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'button_box_padding_v2',
            [
                'label'      => esc_html__( 'Padding', 'restlycore' ),
                'type'       => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors'  => [
                    '{{WRAPPER}} .button .theme-cta-btns' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
            $this->start_controls_tabs(
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'type'      => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .button .theme-cta-btns' => 'color: {{VALUE}}',
                        ],
                    ]
                );
                $this->add_responsive_control(
                    'button_color_v2_icon',
                    [
                        'label'     => esc_html__( 'Icon Color', 'restlycore' ),
                        'type'      => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .header-thirteen .theme-cta-btns i' => 'color: {{VALUE}}',
                        ],
                    ]
                );
                $this->add_group_control(
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                        'selectors'  => [
                            '{{WRAPPER}} .button .theme-cta-btns' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ]
                );
                $this->add_group_control(
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'type'      => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .button .theme-cta-btns:hover' => 'color: {{VALUE}}',
                            '{{WRAPPER}} .header-thirteen .theme-cta-btns i:hover' => 'color: {{VALUE}}',
                        ],
                    ]
                );
                $this->add_group_control(
                    ...
                    [
                        'name'     => 'button_hbg_v2',
                        'types'    => ['classic', 'gradient'],
                        'selector' => '{{WRAPPER}} .button .theme-cta-btns:hover',
                    ]
                );
                $this->add_group_control(
                    \Elementor\Group_Control_Border::get_type(),
                    [
                        'name'     => 'button_hborder_v2',
                        'selector' => '{{WRAPPER}} .button .theme-cta-btns:hover',
                    ]
                );
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                        'selectors'  => [
                            '{{WRAPPER}} .button .theme-cta-btns:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ]
                );
                $this->add_group_control(
               ...
               <div class="header-top">
                    <div class="container">
                        <div class="row align-items-center">
                            <?php if ( $settings['top_contact_items'] ) : ?>
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6  top-header-left">
                                    <ul>
                                        <?php foreach ( $settings['top_contact_items'] as $item ): ?>
                                        <li><span><?php \Elementor\Icons_Manager::render_icon( $item['top_list_icon'], [ 'aria-hidden' => 'true' ] ); ?></span><?php echo wp_kses( $item['top_left_title'], 'restly_allowed_html' ); ?></li>
                                        <?php endforeach;?>
                                    </ul>
                                </div>
                            <?php endif; ?>
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 top-header-right">
                                <?php if ( !empty( $settings['top_social_list'] ) ): ?>
                                    <ul>
                                        <?php foreach ( $settings['top_social_list'] as $social ): 
                                               $surl      = $social['top_social_link']['url'];
                                               $starget   = $social['top_social_link']['is_external'] ? ' target="_blank"' : '';
                                               $snofollow = $social['top_social_link']['nofollow'] ? ' rel="nofollow"' : '';
                                               ?>
                                            <li>
                                                <a href="<?php echo esc_url($surl); ?>">
                                                <span><?php \Elementor\Icons_Manager::render_icon( $social['top_social_icon'], [ 'aria-hidden' => 'true' ] ); ?> </span>
                                                <?php echo esc_html( $social['top_social_label'] ); ?>
                                                </a>
                                            </li>
                                        <?php endforeach;?>
                                    </ul>
                ...
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-light main-navigation" id="site-navigation">
                        ...
                        <?php  if ( $settings['enable_cta_btn'] == 'yes' ) : ?>
                            ...
                            <div class="button header-cta-button-v2 d-none d-xl-flex"> 
                                <a <?php echo $this->get_render_attribute_string( 'cta_button_url' ); ?>  class="theme-cta-btns">
                                    <?php \Elementor\Icons_Manager::render_icon( $settings['cta_button_icon'], [ 'aria-hidden' => 'true' ] ); ?>
...
Plugin::instance()->widgets_manager->register( new restly_header_template_thirteen );