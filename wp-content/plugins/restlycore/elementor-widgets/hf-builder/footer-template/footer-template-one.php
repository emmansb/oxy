...
class restly_footer_template_one extends Widget_Base {

    public function get_name() {

        return 'restly_footer_template_one';
    }

    public function get_title() {
        return esc_html__( 'Restly Footer one', 'restlycore' );
    }
                                    ...
                                    <div class="widget footer-widtet contact-widget">
                                        ...
                                        <div class="company-contact-widget">
                                            <ul>
                                                ...
                                                <li><?php \Elementor\Icons_Manager::render_icon( $item['contact_info_icon'], [ 'aria-hidden' => 'true' ] ); ?> <?php echo wp_kses( $item['contact_info_dec'], $allowed_html ); ?></li>
                                                <?php endforeach; ?>
                                            </ul>
                                        </div>
                                    </div>					
...
Plugin::instance()->widgets_manager->register( new restly_footer_template_one );